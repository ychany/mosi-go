...
import { BusFront, HeartHandshake, LayoutDashboard, Users } from "@/components/icons";
...
export default function Home() {
  return (
    <main className="flex-1 grad flex flex-col items-center justify-center px-6 py-16 text-white">
      ...
      <h1 className="text-6xl font-extrabold mb-2 tracking-tight flex items-center gap-3">
        <BusFront size={52} strokeWidth={2.2} />
        모시GO
      </h1>
      ...
      <div className="grid gap-4 sm:grid-cols-3 w-full max-w-3xl">
        {CHANNELS.map((c) => (
          ...
          >
            <div className="w-12 h-12 bg-primary-light rounded-xl grid place-items-center text-primary-dark mb-4">
              <c.icon size={24} />
            </div>
